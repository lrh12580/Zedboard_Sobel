...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { out_V_offset_dout { I 32 vector } out_V_offset_empty_n { I 1 bit } out_V_offset_read { O 1 bit } } \
} "
}
