...
architecture behav of Stream2Mem is 
    ...
    signal i_reg_110 : STD_LOGIC_VECTOR (22 downto 0);
    ...
    signal i_5_fu_151_p2 : STD_LOGIC_VECTOR (22 downto 0);
    ...
    signal tmp_12_cast_fu_121_p1 : STD_LOGIC_VECTOR (32 downto 0);
...
begin
    ...
    i_5_fu_151_p2 <= std_logic_vector(unsigned(i_reg_110) + unsigned(ap_const_lv23_1));
    ...
    m_axi_out_V_AWLEN <= ap_const_lv32_400000;
    ...
    sum2_fu_129_p2 <= std_logic_vector(unsigned(tmp_12_cast_fu_121_p1) + unsigned(sext_cast_fu_125_p1));
    tmp_12_cast_fu_121_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(out_V_offset1),33));
    tmp_fu_145_p2 <= "1" when (i_reg_110 = ap_const_lv23_400000) else "0";
end behav;
