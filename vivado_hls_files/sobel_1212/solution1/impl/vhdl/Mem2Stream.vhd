...
architecture behav of Mem2Stream is 
    ...
    signal i_reg_103 : STD_LOGIC_VECTOR (22 downto 0);
    ...
    signal i_7_fu_144_p2 : STD_LOGIC_VECTOR (22 downto 0);
    ...
    signal tmp_20_cast_fu_114_p1 : STD_LOGIC_VECTOR (32 downto 0);
...
begin
    ...
    i_7_fu_144_p2 <= std_logic_vector(unsigned(i_reg_103) + unsigned(ap_const_lv23_1));
    ...
    sum2_fu_122_p2 <= std_logic_vector(unsigned(tmp_20_cast_fu_114_p1) + unsigned(sext_cast_fu_118_p1));
    tmp_20_cast_fu_114_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(in_V_offset1),33));
    tmp_fu_138_p2 <= "1" when (i_reg_103 = ap_const_lv23_400000) else "0";
end behav;
