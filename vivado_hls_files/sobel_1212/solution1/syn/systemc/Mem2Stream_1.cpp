...
const sc_lv<19> Mem2Stream_1::ap_const_lv19_0 = "0000000000000000000";
const sc_lv<32> Mem2Stream_1::ap_const_lv32_40000 = "1000000000000000000";
const sc_lv<19> Mem2Stream_1::ap_const_lv19_40000 = "1000000000000000000";
const sc_lv<19> Mem2Stream_1::ap_const_lv19_1 = "1";
...
Mem2Stream_1::Mem2Stream_1(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    SC_METHOD(thread_i_6_fu_144_p2);
    sensitive << ( i_reg_103 );
    ...
    sensitive << ( tmp_25_cast_fu_114_p1 );
    sensitive << ( sext_cast_fu_118_p1 );

    SC_METHOD(thread_tmp_25_cast_fu_114_p1);
    ...
    sc_trace(mVcdFile, i_6_fu_144_p2, "i_6_fu_144_p2");
    ...
    sc_trace(mVcdFile, tmp_25_cast_fu_114_p1, "tmp_25_cast_fu_114_p1");
...
void Mem2Stream_1::thread_i_6_fu_144_p2() {
    i_6_fu_144_p2 = (!i_reg_103.read().is_01() || !ap_const_lv19_1.is_01())? sc_lv<19>(): (sc_biguint<19>(i_reg_103.read()) + sc_biguint<19>(ap_const_lv19_1));
}
...
void Mem2Stream_1::thread_sext_cast_fu_118_p1() {
    sext_cast_fu_118_p1 = esl_zext<33,30>(in_V_offset.read());
}

void Mem2Stream_1::thread_sum2_cast_fu_128_p1() {
    sum2_cast_fu_128_p1 = esl_zext<64,33>(sum2_fu_122_p2.read());
}

void Mem2Stream_1::thread_sum2_fu_122_p2() {
    sum2_fu_122_p2 = (!tmp_25_cast_fu_114_p1.read().is_01() || !sext_cast_fu_118_p1.read().is_01())? sc_lv<33>(): (sc_biguint<33>(tmp_25_cast_fu_114_p1.read()) + sc_biguint<33>(sext_cast_fu_118_p1.read()));
}

void Mem2Stream_1::thread_tmp_25_cast_fu_114_p1() {
    tmp_25_cast_fu_114_p1 = esl_zext<33,32>(in_V_offset1.read());
}

void Mem2Stream_1::thread_tmp_fu_138_p2() {
    tmp_fu_138_p2 = (!i_reg_103.read().is_01() || !ap_const_lv19_40000.is_01())? sc_lv<1>(): sc_lv<1>(i_reg_103.read() == ap_const_lv19_40000);
}
