...
#ifndef __image_filter_mac_ibs__HH__
#define __image_filter_mac_ibs__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(image_filter_mac_ibs) {
    ...
    SC_CTOR(image_filter_mac_ibs):  simcore_mac_0_U ("simcore_mac_0_U") {
