...
#ifndef __image_filter_sitoeOg__HH__
#define __image_filter_sitoeOg__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(image_filter_sitoeOg) {
    ...
    SC_CTOR(image_filter_sitoeOg):  ACMP_sitodp_U ("ACMP_sitodp_U") {
